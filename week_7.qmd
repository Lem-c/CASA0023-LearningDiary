...
![Points represent: River (blue), Park (green), Soil (brown), Buildings (grey).](asset/screenshot/week07/points.png){fig-align="center"}
...
![Greenery classification](asset/screenshot/week07/much_better.png){width="300" height="150"} ![Buildings classification](asset/screenshot/week07/Builds_Parks.png){fig-align="right" width="300" height="150"}

The unused land in London appears minimal, indicating a well-developed area.

![Brown indicates the possible un-used land](asset/screenshot/week07/result.png){width="561"}
